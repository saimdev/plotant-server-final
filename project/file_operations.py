...
class DataProcessor:
    ...
    #     result = {'x': unique_x_values, 'y': y_values_with_respect_to_unique_x_values}
    #     return json.dumps(result)
    
    # def get_multi_fields(self, email, xLabels, yLabels, project_name, file_name):
    #     main_folder = os.path.join(main_storage, user_storage)
    #     user_folder = os.path.join(main_folder, email)
    #     project_folder = os.path.join(user_folder, project_name)
    #     file = os.path.join(project_folder, file_name)
    ...
    #     result = self.multi_field_data(xLabels, yLabels, data)
    ...
    def get_labels_legends(self,email, x, y, z, project_name, file_name):
        ...
        if y == z:
            ...
            #     print(isinstance(y, str),isinstance(z, float) )
            #     tmp = x
            #     x = y
            #     y = tmp
        ...
        if os.path.exists(project_folder):
            for file in os.listdir(project_folder):
                if file == filename:
                    ...
                    # print(self.find_value_location(data, value))
